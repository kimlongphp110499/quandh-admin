...
const editingItemType = ref<ItemType | null>(null)
...
const statusToggleItem = ref<ItemType | null>(null)
...
const headers = ITEM_TYPE_TABLE_HEADERS
...
const openEditDrawer = (itemType: ItemType) => {
...
const handleToggleStatus = (itemType: ItemType) => {
