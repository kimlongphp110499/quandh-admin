...
import type { TaskAssignmentDepartment, TaskAssignmentDepartmentFormData } from '@/api/modules/task-assignment-department'
import AppSnackbar from '@/components/AppSnackbar.vue'

interface Props {
  isDrawerOpen: boolean
  department?: TaskAssignmentDepartment | null
}
...
const formData = ref<TaskAssignmentDepartmentFormData>({
  code: '',
  name: '',
  description: '',
  status: 'active',
