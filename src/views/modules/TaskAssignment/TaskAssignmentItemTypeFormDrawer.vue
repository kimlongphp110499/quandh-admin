...
// eslint-disable-next-line import/no-unresolved
import type { TaskAssignmentItemType, TaskAssignmentItemTypeFormData } from '@/api/modules/task-assignment-item-type'
import AppSnackbar from '@/components/AppSnackbar.vue'

interface Props {
  isDrawerOpen: boolean
  itemType?: TaskAssignmentItemType | null
}
...
const formData = ref<TaskAssignmentItemTypeFormData>({
  name: '',
  description: '',
  status: 'active',
})
