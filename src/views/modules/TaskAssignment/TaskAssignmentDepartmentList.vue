...
import TaskAssignmentDepartmentFormDrawer from './TaskAssignmentDepartmentFormDrawer.vue'
...
import { useTaskAssignmentDepartmentStore } from '@/store/modules/task-assignment-department'
import type { TaskAssignmentDepartment } from '@/api/modules/task-assignment-department'

const store = useTaskAssignmentDepartmentStore()

const isFormDrawerVisible = ref(false)
const editingDepartment = ref<TaskAssignmentDepartment | null>(null)
const selected = ref<TaskAssignmentDepartment[]>([])
...
const statusToggleItem = ref<TaskAssignmentDepartment | null>(null)
...
const headers = [
  ...
  { title: 'Mã phòng ban', key: 'code', sortable: true, align: 'start' as const, minWidth: '100px' },
  { title: 'Tên phòng ban', key: 'name', sortable: true, align: 'start' as const, minWidth: '240px' },
...
const openEditDrawer = (department: TaskAssignmentDepartment) => {
...
const handleToggleStatus = (department: TaskAssignmentDepartment) => {
...
<template>
  <section>
    ...
    <!-- Form Drawer -->
    <TaskAssignmentDepartmentFormDrawer
